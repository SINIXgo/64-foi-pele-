function goodNoteHit(id, dir, nt, sus)
	if (curStep >= 639 and curStep < 767) or (curStep >= 961 and curStep < 1168) then
		createShadow('bf', curStep >= 736 and curStep < 863, {'31B0D1', '31B0D1', '31B0D1', '2FCECB', '2AA1CC'})
	end
end

function opponentNoteHit(id, dir, nt, sus)
	if (curStep >= 671 and curStep < 767) then
		createShadow('dad', curStep >= 960 and curStep < 1088, {'ffaa6f', 'ffaa6f', 'ffaa6f', 'ffaa6f', 'ffaa6f'})
	end
end
